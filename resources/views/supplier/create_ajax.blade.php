<form action="{{ url('/supplier/ajax') }}" method="POST" id="form-tambah">
    ...
    <div class="modal-body">
        ...
        <div class="form-group">
            ...
            <input type="text" name="alamat" id="supplier_alamat" class="form-control" required>
            <small id="error-alamat" class="error-text form-text text-danger"></small>
        </div>
        <div class="form-group">
            <label>Telepon Supplier</label>
            <input type="text" name="telepon" id="supplier_telepon" class="form-control" required>
